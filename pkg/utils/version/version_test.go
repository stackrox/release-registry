...
func TestLatestVersionNightly(t *testing.T) {
	latest, err := version.LatestVersion([]string{
		"1.2.3-nightly-20230320",
		"1.2.3-nightly-20230212",
		"1.2.3-nightly-20230321",
		"1.2.1-nightly-20230321",
		"1.2.3-nightly-20230319",
	})
	assert.NoError(t, err)
	assert.Equal(t, "1.2.3-nightly-20230321", latest)
}
